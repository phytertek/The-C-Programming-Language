...
struct radDoublyLinkedList *doTheStructAssignmentTest()
{
  ...
  struct radDoublyLinkedList *linkedListPointer = malloc(sizeof(struct radDoublyLinkedList));
  linkedListPointer->next = NULL;
  linkedListPointer->last = NULL;
...
{
  // Implement this function
  struct radDoublyLinkedList *item = doTheStructAssignmentTest();
  item->value = value;
